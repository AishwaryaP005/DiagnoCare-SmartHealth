...
def show_page(patient_name): 
    ...
    if uploaded_reports: 
        ...
        for report in uploaded_reports: 
            ...
            with st.expander(f"{diagnosis_date} - {report_type} by Dr. 
{doctor_name}"): 
            ...
            if not patient_name or not symptoms: 
                ...
                try: 
                    st.session_state.pdf_bytes = create_pdf_bytes( 
                        patient_name, symptoms, factors, medications, 
questions 
                    ) 
...
def create_pdf_bytes(patient_name, symptoms, factors, medications, 
questions): 
