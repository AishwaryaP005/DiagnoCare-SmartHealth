...
# Streamlit UI 
st.set_page_config(page_title="SOS Email", page_icon="🚨", 
layout="centered") 
st.title("SOS Email Notification") 
# Configure sender and receiver info 
SENDER_EMAIL = "sender_mail_here" 
SENDER_PASSWORD = "sender_pw_here"   
RECEIVER_EMAIL = "rec_mail_here" 
...
def send_email(): 
   ...
   This is an emergency alert sent from your SOS notification system. 
Please take immediate action. 
 
 
   ### ALERT: 
   A potential emergency situation has been triggered. The system has 
detected a need for urgent assistance. 
