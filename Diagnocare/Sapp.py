...
from pages.login import user_login, doctor_login, user_register, 
doctor_register 
from pages import ( 
    pdf_generator, 
    appointment, 
...
def main(): 
    ...
    if 'role' not in st.session_state and 'page_state' not in 
st.session_state: 
        st.session_state.page_state = "register"  # default to registration 
page 
